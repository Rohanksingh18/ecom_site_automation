...
class CouponsAPIHelper:
    ...
    # Method makes a POST request to create a 'new_coupon' by calling the post-method of the woo_api_utility instance.
    ...
    # Calling 'retrieve_coupon'the get method of the woo_api_utility instance with the coupon ID as a parameter.
    ...
    # Calling 'list all coupons'.the get method of the woo_api_utility instance.
